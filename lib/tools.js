...
function isForbiddenUsername(username) {
    if (username) {
        forbiddenUsernames = ['ataturk', 'allah', 'hzmuhammed', 'kuranikerim', 'index', 'ismetinonu', 'sekiz', 'sekizdestek', 'sekizbilgi', 'sekizresim', 'sekizmuzik']
...
module.exports = { validateEmail, formatDate, checkAuthority, validateDate, isForbiddenUsername }